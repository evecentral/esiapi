...
// WithXUserAgent adds the xUserAgent to the get characters character id implants params
func (o *GetCharactersCharacterIDImplantsParams) WithXUserAgent(xUserAgent *string) *GetCharactersCharacterIDImplantsParams {
	o.SetXUserAgent(xUserAgent)
	return o
}

// SetXUserAgent adds the xUserAgent to the get characters character id implants params
func (o *GetCharactersCharacterIDImplantsParams) SetXUserAgent(xUserAgent *string) {
...
// WithUserAgent adds the userAgent to the get characters character id implants params
func (o *GetCharactersCharacterIDImplantsParams) WithUserAgent(userAgent *string) *GetCharactersCharacterIDImplantsParams {
	o.SetUserAgent(userAgent)
	return o
}

// SetUserAgent adds the userAgent to the get characters character id implants params
func (o *GetCharactersCharacterIDImplantsParams) SetUserAgent(userAgent *string) {
