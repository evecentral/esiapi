...
func (m *GetFwLeaderboardsCharactersOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetFwLeaderboardsCharactersOKBody) validateKills(formats strfmt.Registry) error {
...
func (m *GetFwLeaderboardsCharactersOKBody) validateVictoryPoints(formats strfmt.Registry) error {
...
func (m *GetFwLeaderboardsCharactersOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetFwLeaderboardsCharactersOKBody) UnmarshalBinary(b []byte) error {
