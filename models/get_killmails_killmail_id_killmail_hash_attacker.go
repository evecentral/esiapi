...
// swagger:model get_killmails_killmail_id_killmail_hash_attacker
...
// Validate validates this get killmails killmail id killmail hash attacker
func (m *GetKillmailsKillmailIDKillmailHashAttacker) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetKillmailsKillmailIDKillmailHashAttacker) validateDamageDone(formats strfmt.Registry) error {
...
func (m *GetKillmailsKillmailIDKillmailHashAttacker) validateFinalBlow(formats strfmt.Registry) error {
...
func (m *GetKillmailsKillmailIDKillmailHashAttacker) validateSecurityStatus(formats strfmt.Registry) error {
