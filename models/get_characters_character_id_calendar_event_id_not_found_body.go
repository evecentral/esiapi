...
func (m *GetCharactersCharacterIDCalendarEventIDNotFoundBody) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *GetCharactersCharacterIDCalendarEventIDNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetCharactersCharacterIDCalendarEventIDNotFoundBody) UnmarshalBinary(b []byte) error {
