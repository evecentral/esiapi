...
type GetFwLeaderboardsCorporationsOKBodyVictoryPoints struct {
	...
	// Required: true
	// Max Items: 10
	ActiveTotal []*GetFwLeaderboardsCorporationsOKBodyVictoryPointsActiveTotalItems `json:"active_total"`
	...
	// Required: true
	// Max Items: 10
	LastWeek []*GetFwLeaderboardsCorporationsOKBodyVictoryPointsLastWeekItems `json:"last_week"`
	...
	// Required: true
	// Max Items: 10
	Yesterday []*GetFwLeaderboardsCorporationsOKBodyVictoryPointsYesterdayItems `json:"yesterday"`
}

// Validate validates this get fw leaderboards corporations o k body victory points
func (m *GetFwLeaderboardsCorporationsOKBodyVictoryPoints) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetFwLeaderboardsCorporationsOKBodyVictoryPoints) validateActiveTotal(formats strfmt.Registry) error {
...
func (m *GetFwLeaderboardsCorporationsOKBodyVictoryPoints) validateLastWeek(formats strfmt.Registry) error {
...
func (m *GetFwLeaderboardsCorporationsOKBodyVictoryPoints) validateYesterday(formats strfmt.Registry) error {
...
func (m *GetFwLeaderboardsCorporationsOKBodyVictoryPoints) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetFwLeaderboardsCorporationsOKBodyVictoryPoints) UnmarshalBinary(b []byte) error {
